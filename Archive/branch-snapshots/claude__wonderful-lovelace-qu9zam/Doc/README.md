...
│  └─ sovereign-by-design-v0.2.0.md     # v0.2.0 citation-complete draft
├─ de/                 Deutsch (full translation)
│  └─ souveraen-by-design-v0.2.0.md     # v0.2.0 German translation
└─ build/              DOCX + PDF + HTML, regenerated locally (git-ignored)
```

Prior versions are immutable once released. Add new versions as new files
(e.g. `sovereign-by-design-v0.3.0.md`) rather than overwriting the current file.

## Documents & formats

| Title | Version | Markdown | DOCX | PDF |
|---|---|---|---|---|
| Sovereign by Design (EN) | v0.2.0 | [md](en/sovereign-by-design-v0.2.0.md) | build / CI | build / CI |
| Sovereign by Design (DE) | v0.2.0 | [md](de/souveraen-by-design-v0.2.0.md) | build / CI | build / CI |
...
- **DOCX & PDF** — binary artefacts. They are **not committed** (the automation that
  ...
  1. **Build locally:** `python3 Scripts/build_govtech_docs.py` writes all formats
     into `Doc/build/<lang>/`.
  ...
  3. **Release assets:** pushing a `vX.Y.Z` tag attaches the DOCX/PDF to a GitHub Release.
...
Structural changes are made to the **English source first**, then propagated to translations.
