...
Usage:
    uv run python Scripts/generate_html.py                   # process all papers
    uv run python Scripts/generate_html.py Doc/en/foo.md     # single file

Requires: mistune>=3.0 (managed by uv)
